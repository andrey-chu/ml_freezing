...
#import csv
import pandas as pd
def load_raw_matlab_data(dirlist, h5data_location, wellsize, numwells, substances):
            ...
            for j in range(well_rows):
                for k in range(well_columns):
                    ...
                    if freeze_nums[j,k] == 0:
                        ...
                        st_f = max(freezing_points["freeze_num"][j,k]-11, 0)
                        labels[0,fp] = 1
                        labels[0,st_f:fp] = 2
                        ...
                        if (stupid_algo_results["after_thresh"][j,k]-11<0)|(stupid_algo_results["after_thresh"][j,k]-1>numpoints-1):
