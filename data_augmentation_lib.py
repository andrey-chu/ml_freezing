...
#from_dataset='0_raw_dataset_384bact0freez31.hdf5'    
#to_dataset= 'raw_bact384_aug0.hdf5'
#save_the_movies = False
def augment_data(from_dataset, to_dataset, ang_num, random_seed, save_the_movies):
    ...
    dataset_to_read = datadir+from_dataset
    #dataset_to_read = datadir+'united_raw_dataset_384freez31f2.hdf5'
    dataset_to_write = datadir+to_dataset
        ...
        for angle in angles:
            ...
            for i in range(num_wells_orig):
               ...
               # vert = np.ceil(imstack.shape[2]/20)
                ...
                rand_width = 40
                # import pdb; pdb.set_trace()
                rand_shift=np.int8(np.random.uniform(-rand_width, rand_width))
